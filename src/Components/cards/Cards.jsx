...
const Card = ({ imgSrc, description, additionalInfo }) => {
    ...
    return (
        <div className="bg-white shadow-lg rounded-lg overflow-hidden max-w-sm mx-4"> {/* Agrega mx-4 para el margen horizontal */}
...
const Cards = () => {
    return (
        <div className="flex justify-between"> {/* Distribuye espacio entre las tarjetas y los extremos */}
            <Card
