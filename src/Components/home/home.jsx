...
const Home = ({ backgroundImage, height, width }) => {
    const containerStyle = {
        ...
        width: width || '100%',
        backgroundImage: `url(${backgroundImage || require("../../Components/home/fondo.png")})`,
    ...
    return (
        <div style={containerStyle} className="flex justify-center items-center flex-col text-center">
