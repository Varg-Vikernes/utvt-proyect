...
// Define las URLs de las imágenes fuera de la clase
const imageUrl =
...
const Logo =
  "https://th.bing.com/th/id/OIP.iFthClJcrUpRATGdlxO0yQHaHa?pid=ImgDet&rs=1";
const Referencia =
...
class Map extends React.Component {
  ...
  handleRedirectToGoogleMaps = () => {
    window.location.href =
      "https://www.bing.com/maps?osid=6c7895aa-c4c4-4ca0-a871-49cddd5beb14&cp=19.206308~-99.463778&lvl=16&v=2&sV=2&form=S00027";
  };
  ...
  render() {
    return (
      <div
        id="map"
        className="flex flex-col lg:flex-row items-center justify-center h-screen p-1 mt-0"
      >
